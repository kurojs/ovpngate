...
- /home/kuro/.config/opencode/skills
- /home/kuro/.claude/skills
- /home/kuro/.gemini/skills
- /home/kuro/.copilot/skills
- /home/kuro/.openclaw/skills
...
### ai-sdk-5
- Path: /home/kuro/.config/opencode/skills/ai-sdk-5/SKILL.md
- Trigger: >
- Rules:
...
### backlog-triage
- Path: /home/kuro/.config/opencode/skills/backlog-triage/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### branch-pr
- Path: /home/kuro/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/kuro/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/kuro/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/kuro/.config/opencode/skills/comment-writer/SKILL.md
...
### django-drf
- Path: /home/kuro/.config/opencode/skills/django-drf/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### dotnet
- Path: /home/kuro/.config/opencode/skills/dotnet/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gentleman-bubbletea
- Path: /home/kuro/.config/opencode/skills/gentleman-bubbletea/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gentleman-e2e
- Path: /home/kuro/.config/opencode/skills/gentleman-e2e/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gentleman-installer
- Path: /home/kuro/.config/opencode/skills/gentleman-installer/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gentleman-system
- Path: /home/kuro/.config/opencode/skills/gentleman-system/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### gentleman-trainer
- Path: /home/kuro/.config/opencode/skills/gentleman-trainer/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: /home/kuro/.config/opencode/skills/go-testing/SKILL.md
...
### homebrew-release
- Path: /home/kuro/.config/opencode/skills/homebrew-release/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### issue-creation
- Path: /home/kuro/.config/opencode/skills/issue-creation/SKILL.md
...
### jira-epic
- Path: /home/kuro/.config/opencode/skills/jira-epic/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### jira-task
- Path: /home/kuro/.config/opencode/skills/jira-task/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### judgment-day
- Path: /home/kuro/.config/opencode/skills/judgment-day/SKILL.md
...
### maintainer-voice
- Path: /home/kuro/.config/opencode/skills/maintainer-voice/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### nextjs-15
- Path: /home/kuro/.config/opencode/skills/nextjs-15/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### nlm-skill
- Path: /home/kuro/.config/opencode/skills/nlm-skill/SKILL.md
...
### playwright
- Path: /home/kuro/.config/opencode/skills/playwright/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### pr-review
- Path: /home/kuro/.config/opencode/skills/pr-review/SKILL.md
- Trigger: >
- Rules:
...
### pytest
- Path: /home/kuro/.config/opencode/skills/pytest/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### react-19
- Path: /home/kuro/.config/opencode/skills/react-19/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### release-note-safety
- Path: /home/kuro/.config/opencode/skills/release-note-safety/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### repo-hardening
- Path: /home/kuro/.config/opencode/skills/repo-hardening/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### scope-rule-architect-angular
- Path: /home/kuro/.config/opencode/skills/angular/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /home/kuro/.config/opencode/skills/skill-creator/SKILL.md
...
### stream-deck
- Path: /home/kuro/.config/opencode/skills/stream-deck/SKILL.md
- Trigger: >
- Rules:
...
### tailwind-4
- Path: /home/kuro/.config/opencode/skills/tailwind-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### technical-review
- Path: /home/kuro/.config/opencode/skills/technical-review/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### typescript
- Path: /home/kuro/.config/opencode/skills/typescript/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /home/kuro/.config/opencode/skills/work-unit-commits/SKILL.md
...
### zod-4
- Path: /home/kuro/.config/opencode/skills/zod-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### zustand-5
- Path: /home/kuro/.config/opencode/skills/zustand-5/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
